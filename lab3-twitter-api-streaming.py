...
if __name__ == '__main__':
    ...
    stream.filter(track=["Karolcariola","GiorgioJackson","SenadorGuillier","felipeharboe","camila_vallejo","gabrielboric","gustavohasbun","senadornavarro","ivanmoreirab","Chile_Vamos_","NuevaMayoriacl","ceciperez1","urrutiaosvaldo","ignaciowalker","lautarocarmona","RojoEdwards","Hugo_Gutierrez_","marconunez","iallendebussi","hgonzaduran"])
